...
def test_free_response_topics_bypass_mention_requirement_without_opening_whole_chat():
    adapter = _make_adapter(
        require_mention=True,
        allowed_chats=["-100"],
        free_response_topics=[{"chat_id": "-100", "thread_id": "259"}],
    )
...
def test_free_response_topics_accept_string_entries_and_general_topic():
    adapter = _make_adapter(
        ...
        free_response_topics=["-100:1", ["-200", 7]],
    )
